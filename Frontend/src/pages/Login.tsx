    ...
    <div className="flex flex-col items-center justify-center py-16 px-4">
      <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-xl p-8 space-y-6 shadow-md">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-zinc-400">Log in to solve problems and track submissions</p>
        </div>

        {sessionExpiredMsg && (
          <div className="flex items-center space-x-2 bg-amber-500/10 border border-amber-500/20 text-amber-400 p-3 rounded text-xs">
